    ...
    <div className="w-full animate-slide-up">
      ...
      <div className="bg-white rounded-[var(--radius-xl)] shadow-[var(--shadow-card)] p-8 border border-[var(--border-light)]">
        <form className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <label
              htmlFor="remember"
              className="text-sm font-medium text-[var(--text-dark)] leading-none cursor-pointer"
            >
              Ghi nhớ đăng nhập
            </label>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-[var(--text-muted)] font-medium">Hoặc</span>
            </div>
          </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-xs text-[var(--text-muted)]">
          ...
          <a href="#" className="text-[var(--gold)] hover:underline">Điều khoản sử dụng</a>
          {' '}và{' '}
          <a href="#" className="text-[var(--gold)] hover:underline">Chính sách bảo mật</a>
        </p>
      </div>
    </div>
  );
