...
export default function GenerateMealPlanModal({ 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="bg-white rounded-[var(--radius-lg)] w-full max-w-lg shadow-2xl animate-slide-up max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button
              ...
              className="flex-1 bg-gradient-gold text-white font-semibold rounded-[var(--radius-btn)] shadow-[var(--shadow-btn)] hover-lift transition-smooth disabled:opacity-50"
            >
