  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="bg-white rounded-[var(--radius-lg)] w-full max-w-md shadow-2xl animate-slide-up">
        {/* Header */}
        <div className="bg-gradient-gold text-white p-6 rounded-t-[var(--radius-lg)]">
          ...
          <Tabs defaultValue="url" className="w-full">
            ...
            <TabsContent value="url" className="space-y-4 mt-4">
              ...
              <Button
                ...
                className="w-full bg-gradient-gold text-white font-semibold rounded-[var(--radius-btn)] shadow-[var(--shadow-btn)] hover-lift transition-smooth disabled:opacity-50"
              >
                {loading ? (
                  <>
            ...
            <TabsContent value="file" className="space-y-4 mt-4">
              ...
              <Button
                disabled
                className="w-full bg-gradient-gold text-white font-semibold rounded-[var(--radius-btn)] shadow-[var(--shadow-btn)] opacity-50"
              >
                <Upload className="w-4 h-4 mr-2" />
                Import từ file
              </Button>
