...
export default function ViewInventoryDetailsModal({ 
  isOpen, 
  onClose, 
  item 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="bg-white rounded-[var(--radius-lg)] w-full max-w-md shadow-2xl animate-slide-up">
        {/* Header with Image */}
        <div className="relative h-48 bg-gradient-to-br from-[#22C55E] to-[#16A34A] rounded-t-[var(--radius-lg)] overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Expiry */}
          <div className="flex items-start gap-3 p-4 bg-[var(--card-bg)] rounded-[var(--radius-sm)]">
            <Calendar className="w-5 h-5 text-[#22C55E] mt-0.5" />
            <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            <Button
              className="bg-gradient-to-r from-[#22C55E] to-[#16A34A] text-white font-semibold rounded-[var(--radius-btn)] shadow-lg hover:shadow-xl transition-smooth"
            >
              Sử dụng
            </Button>
          </div>
