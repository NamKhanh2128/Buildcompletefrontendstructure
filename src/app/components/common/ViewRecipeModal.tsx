...
export default function ViewRecipeModal({ 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="bg-white rounded-[var(--radius-lg)] w-full max-w-3xl shadow-2xl animate-slide-up max-h-[90vh] overflow-y-auto">
        {/* Header */}
            ...
            <div className="space-y-4">
              {(recipe.steps || [
                ...
                <div key={index} className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-gradient-gold text-white flex items-center justify-center font-bold text-sm shrink-0">
                    {index + 1}
                  </div>
